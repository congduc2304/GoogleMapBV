...
GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      // LatLng sydney = new LatLng(21.02195648, 105.85232753);
    ...
    private void getNearByHospitals() {
        ...
        StringBuilder stringBuilder=
                new StringBuilder("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=21.00966713,105.74673957&radius=1500&type=Bệnh Viện &keyword=cruise&key=AIzaSyB9CHWOZzwFo195sTB5GHUqSzJX3dyuMb4")  ;
